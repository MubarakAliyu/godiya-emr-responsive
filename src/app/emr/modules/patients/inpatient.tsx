...
import { Activity, Bed, BedDouble, Calendar, ChevronLeft, ChevronRight, Clock, DoorOpen, Edit, Eye, Filter, RotateCcw, Search, Skull, Stethoscope, Trash2, TrendingUp, User, UserCircle, UserPlus, UserX } from 'lucide-react';
...
export function InpatientPage() {
  ...
  // Filter IPD patients only - use live data from API
  ...
  const handleViewFile = (patient: Patient) => {
    if (patient.fileType === 'Family') {
      ...
      navigate(`${patientBasePath}/${patient.id}`);
    }
  };
