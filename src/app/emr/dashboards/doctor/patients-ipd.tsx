...
export function DoctorIPDPatients() {
  ...
  const fetchIPDPatients = useCallback(async (isRefresh = false) => {
    try {
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <Button
                          ...
                          onClick={() => navigate(`/emr/doctor/patients/${patient.admission_patient}/ipd-file`)}
                        >
