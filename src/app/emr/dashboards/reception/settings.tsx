...
export function ReceptionSettings() {
  ...
  const handleSavePin = async () => {
    ...
    try {
      ...
      toast.success(hasPin ? 'Transaction PIN updated!' : 'Transaction PIN set successfully!');
      setHasPin(true);
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {hasPin
                ? 'Your transaction PIN is active. Enter a new PIN below to update it.'
                : 'Set a 4–6 digit PIN used to authorize sensitive actions (e.g. payment confirmations).'}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
